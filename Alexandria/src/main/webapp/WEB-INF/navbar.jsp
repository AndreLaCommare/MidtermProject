...
<nav class="navbar navbar-expand-lg bg-body-tertiary" style="color: #792109">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse d-flex flex-row justify-content-between" id="navbarTogglerDemo01">
