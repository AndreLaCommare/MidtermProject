...
INSERT INTO `language` (`id`, `name`) VALUES (4, 'Chinese');
INSERT INTO `language` (`id`, `name`) VALUES (5, 'French');
INSERT INTO `language` (`id`, `name`) VALUES (6, 'German');
INSERT INTO `language` (`id`, `name`) VALUES (7, 'Italian');
INSERT INTO `language` (`id`, `name`) VALUES (8, 'Greek');
INSERT INTO `language` (`id`, `name`) VALUES (9, 'Hebrew');
INSERT INTO `language` (`id`, `name`) VALUES (10, 'Lebanese');
INSERT INTO `language` (`id`, `name`) VALUES (11, 'Spanish');
...
INSERT INTO `book` (`id`, `cover_url`, `title`, `description`, `pages`, `published_year`, `price`, `isbn`, `language_id`, `author_id`) VALUES (8, 'https://kbimages1-a.akamaihd.net/68229b42-3d06-4e3e-a26c-347144ee829f/353/569/90/False/the-divine-comedy-163.jpg', 'The Divine Comedy', 'Dante\'s masterpiece of literature is well matched by the peerless art of Gustave Dore. Dante and his guides, Virgil and Beatrice, journey through the cantos in an allegory of the passage of the soul through the Afterlife, with the subtle engraving of Dore\'s illustrations perfectly complementing the movement from darkness through to light.', 432, 1472, 30.00, '1786648113', 7, 8);
...
>>>>>>> 97c2e3e7d00b9f4b931c274eb3c9b2f9f65e6b9c
...
START TRANSACTION;
USE `alexandriaDB`;
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `image_url`, `first_name`, `last_name`, `about_me`) VALUES (1, 'admin', 'admin', 1, 'admin', 'https://cdn-icons-png.flaticon.com/512/1071/1071164.png', 'Mr. ', 'Admin', 'I am the administrator for Alexandria Book Club!');
